class Awless < Formula
  ...
  homepage "https://github.com/dannykansas/awless"
  url "https://github.com/dannykansas/awless.git",
        :tag => version
  head "https://github.com/dannykansas/awless.git"

  bottle do
    root_url "https://github.com/dannykansas/homebrew-awless/releases/download/#{version}"
  ...
  def install
    ...
    dir = buildpath/"src/github.com/dannykansas/awless"
